            ...
            <div className='FormPayment shadow'>
                    ...
                    isCoupon && (
                        <div className='price-breakdown'>
                            ...
                            <div>
                                ...
                                <span className='t-14 f-500 text-orange'>$1,740.00 USD off &nbsp;
                                    <i 
                ...
                <form action='asfasfsa'>
                    <div className='form-group'>
                        {   !isCoupon &&
                                <input className='form-control form-control-sm' type={'text'} name={'email'} placeholder={'Coupon'}></input>
                        }
                        <input className='form-control form-control-sm' type={'email'} placeholder={'Email address'} required></input>
                        <br/>
                        {
                            !paymentMethod && (
                                <div className='checks-group'>
                                    ...
                                    <div className="form-check">
                                        ...
                                        />
                                        <label className="form-check-label text-gray" htmtFor="exampleRadios2">
                                            Paypal
                                        </label>
                                    </div>
                                </div>
                        ...
                        }
                        {
                            paymentMethod && (
                                <span 
                                    className='t-12 text-orange change-method-text'
                                    onClick={() => setPaymentMethod(null)}
                                >change a payment method</span>       
                            )
                        }
                        <br/>
                        <div>
