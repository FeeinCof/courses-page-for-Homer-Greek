...
function CardVideo({ onClick, shadow }) {
  return (
    <>
      <div
        className={classNames('CardVideo', {
          shadow: shadow,
        })}
      >
        <div className="CardHeader" onClick={() => onClick()}>
          ...
          <div>
            ...
            <div className="CardHeader-body">
              <span>
                <b>Convert your PM interviews into offer letters </b>
              </span>
              <span>
                Step-by-step walkthrougns to give 10/10 answers to any PM interview question that might be thrown your
                way.
              </span>
            </div>
          </div>
